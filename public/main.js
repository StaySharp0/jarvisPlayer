...
/***/ function(module, exports, __webpack_require__) {
	...
	var _PlayerUI = __webpack_require__(80);
	
	var _PlayerUI2 = _interopRequireDefault(_PlayerUI);
	
	var _VoiceCommand = __webpack_require__(81);
	
	var _VoiceCommand2 = _interopRequireDefault(_VoiceCommand);
	...
	playerUI.init({
	  ...
	  prev: function prev() {
	    player.prev();playerUI.set(player.getMusicInfo());
	  },
	  next: function next() {
	    player.next();playerUI.set(player.getMusicInfo());
	  },
	  playOpion: function playOpion(option) {
	...
	player.setEnvets('statechange', function (state, op) {
	  if (state === 'playing') playerUI.togglePlay('pause');
	  if (state === 'finished') {
	    if (op.repeat) {
	      var musicInfo = player.next();
	      playerUI.set(musicInfo);
	    } else if (op.repeat_one) {
	      player.seek(0);
	      player.play();
	    } else if (op.shuffle) {
	      var _musicInfo = player.shufflePlay();
	      playerUI.set(_musicInfo);
	    } else {
	...
	var vc = new _VoiceCommand2.default({
	  pause: function pause() {
	    $('#pause').click();
	  },
	  list_play: function list_play() {
	    $('.music-tr').eq(0).click();
	  },
	  play: function play() {
	    $('#play').click();
	  ...
	  show_playlist: function show_playlist(tag) {
	    $('.side-item').map(function (idx, e) {
	      var title = $(e).html().toLowerCase().trim();
	    ...
	    $('.playlist-item').map(function (idx, e) {
	      var title = $(e).html().toLowerCase().trim();
	  ...
	  play_playlist: function play_playlist(tag) {
	    $('.side-item').map(function (idx, e) {
	      var title = $(e).html().toLowerCase();
	      title = title.substring(title.indexOf('</i>') + 4).trim();
	  ...
	  set_volume: function set_volume(tag) {
	    var vol = $('#volume').val();
	    if (tag === 'up') {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _playlistTpl = __webpack_require__(22);
	
	var _playlistTpl2 = _interopRequireDefault(_playlistTpl);
	
	var _addMusicTpl = __webpack_require__(23);
	
	var _addMusicTpl2 = _interopRequireDefault(_addMusicTpl);
	...
	var LayoutUI = function () {
		...
		_createClass(LayoutUI, [{
			key: 'init',
			value: function init(playerUI, player) {
			...
			key: '_SearchEvnet',
			value: function _SearchEvnet(socket) {
				var _this = this;
	
				$(this.form).submit(function (e) {
					var keyword = $(_this.form).find('input').val();
			...
			key: '_ListEvent',
			value: function _ListEvent(socket, playerUI, player) {
				var _this2 = this;
	
				$(document).on('click', '.music-tr', function (e) {
					var idx = $(e.currentTarget).data('index');
					var key = $('.container').data('key');
	
					if (player.getListKey() !== _this2._updateList.key) {
						player.setList(_this2._updateList);
					}
			...
			key: '_SettingEvent',
			value: function _SettingEvent(socket) {
				$(document).on('click', '#scan-directory', function () {
					var data = $('#ipt_directory').val();
			...
			value: function _PlayListEvent(socket) {
				...
				//Rename PlayList
				$(document).on('click', '#rename-playlist', function () {
					var obj = {
				...
				$(document).on('click', '#add-music', function () {
					...
					$('#frm-Music2playlist [type=checkbox]:checked').map(function (idx, e) {
			...
			key: '_SetSocketRoute',
			value: function _SetSocketRoute(socket, playerUI, player) {
				var _this4 = this;
	
				socket.on('set Music', function (data) {
					player.setMusic(data.idx, data.buf);
				});
	
				socket.on('update PlayList', function (data) {
					_this4.updatePlayList(data);
				});
	
				socket.on('update List', function (data) {
					_this4._updateList = data[0];
					_this4.updateList(data[0]);
	
					if (data[0].key === 'search') {
						$(_this4.playlist).hide();
						$('.side-item').removeClass('on');
						$('.playlist-item').removeClass('on');
					} else if (data[0].key === 'Songs') {
						$('#frm-Music2playlist').html((0, _addMusicTpl2.default)(data[0]));
					}
				});
			}
		}, {
			...
			value: function updatePlayList() {
				...
				$(this.playlist).html((0, _playlistTpl2.default)(o));
			...
			value: function updateList() {
				...
				$(this.main).html((0, _listTpl2.default)(o));
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams,depths) {
	  ...
	  return "    <a class='dropdown-button btn btn-option' href='#' data-activates='option'>option</a>\n    <ul id='option' class='dropdown-content'>\n    <li><a href=\"#playlist_addMusic-modal\"><i class=\"material-icons\">music_note</i> Add Musics</a></li>\n      <li><a href=\"#playlist_rename-modal\"><i class=\"material-icons\">mode_edit</i> Rename</a></li>\n      <li><a href=\"#playlist_del-modal\"><i class=\"material-icons\">delete</i>Delete</a></li>\n    </ul>\n\n    <div id=\"playlist_rename-modal\" class=\"modal modal-fixed-footer\">\n      <div class=\"modal-content\">\n        <h4 class=\"ellipsis\">What would you like to rename \""
	    ...
	    + alias1(alias2((depths[1] != null ? depths[1].title : depths[1]), depth0))
	    + "\" id=\"rename-ipt_title\" type=\"text\" class=\"validate\">\n            <label for=\"rename-ipt_title\">Title</label>\n        </div>\n        <div class=\"input-field col s6\">\n            <input value=\""
	    + alias1(alias2((depths[1] != null ? depths[1].subtitle : depths[1]), depth0))
	    + "\" id=\"rename-ipt_subtitle\" type=\"text\" class=\"validate\">\n            <label for=\"rename-ipt_subtitle\">Sub Title</label>\n        </div>\n      </div>\n      <div class=\"modal-footer\">\n        <a id=\"rename-playlist\" class=\"modal-action modal-close waves-effect waves-light btn-flat active\">OK</a>\n        <a class=\"modal-action modal-close waves-effect waves-light btn-flat\">Cancle</a>\n      </div>\n    </div>\n\n    <div id=\"playlist_del-modal\" class=\"modal modal-fixed-footer\">\n      <div class=\"modal-content\">\n        <h4 class=\"ellipsis\">Delete Playlist</h4>\n            Do you really want to delete this playlist?\n      </div>\n      <div class=\"modal-footer\">\n        <a id=\"del-playlist\" class=\"modal-action modal-close waves-effect waves-light btn-flat active\">Agree</a>\n        <a class=\"modal-action modal-close waves-effect waves-light btn-flat \">DisAgree</a>\n      </div>\n    </div>\n";
	  ...
	  "      <tr class=\"music-tr\" data-index=\""
	    ...
	    + "</td>\n        <td>\n";
	  stack1 = ((helper = (helper = helpers.artist || (depth0 != null ? depth0.artist : depth0)) != null ? helper : alias2),(options={"name":"artist","hash":{},"fn":container.program(4, data, 0),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
	  if (!helpers.artist) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  ...
	  return buffer + "        </td>\n        <td>"
	    ...
	    var stack1, helper, options, alias1=depth0 != null ? depth0 : {}, alias2=helpers.helperMissing, alias3="function", alias4=container.escapeExpression, buffer = 
	  "<div class=\"container\" data-key=\""
	    + alias4(((helper = (helper = helpers.key || (depth0 != null ? depth0.key : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data}) : helper)))
	    + "\">\n  <h3 class=\"title ellipsis\">"
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "</h3>\n  <h4 class=\"sub-title ellipsis\">"
	    ...
	    + "</div>\n\n"
	    + ((stack1 = helpers["if"].call(alias1,(depth0 != null ? depth0.option : depth0),{"name":"if","hash":{},"fn":container.program(1, data, 0, blockParams, depths),"inverse":container.noop,"data":data})) != null ? stack1 : "")
	    + "  \n  <table class=\"bordered highlight\">\n    <thead>\n      <tr>\n        <th data-field=\"title\">Title</th>\n        <th data-field=\"Artist\">Artist</th>\n        <th data-field=\"album\">Album</th>\n        <th data-field=\"time\">time</th>\n      </tr>\n    </thead>\n\n    <tbody>\n";
	  stack1 = ((helper = (helper = helpers.musics || (depth0 != null ? depth0.musics : depth0)) != null ? helper : alias2),(options={"name":"musics","hash":{},"fn":container.program(3, data, 0, blockParams, depths),"inverse":container.noop,"data":data}),(typeof helper === alias3 ? helper.call(alias1,options) : helper));
	  if (!helpers.musics) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
	  if (stack1 != null) { buffer += stack1; }
	  return buffer + "    </tbody>\n  </table>\n</div>";
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<li><a class=\"playlist-item ellipsis\" data-event=\"playlist\" data-key=\""
	    + alias4(((helper = (helper = helpers.key || (depth0 != null ? depth0.key : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"key","hash":{},"data":data}) : helper)))
	    + "\">"
	    + alias4(((helper = (helper = helpers.title || (depth0 != null ? depth0.title : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"title","hash":{},"data":data}) : helper)))
	    + "</a></li>\n";
	  ...
	  return "<li><a href=\"#playlist_add-modal\"><i id=\"btn-playlist_add\" class=\"material-icons\">playlist_add</i>Add PlayLists</a></li>\n"
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "<p>\n  <input type=\"checkbox\" id=\"add_muisc-"
	    + alias4(((helper = (helper = helpers.index || (depth0 != null ? depth0.index : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
	    + "\" data-index=\""
	    + alias4(((helper = (helper = helpers.index || (depth0 != null ? depth0.index : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"index","hash":{},"data":data}) : helper)))
	    + "\">\n  <label for=\"add_muisc-"
	  ...
	  stack1 = ((helper = (helper = helpers.musics || (depth0 != null ? depth0.musics : depth0)) != null ? helper : helpers.helperMissing),(options={"name":"musics","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data}),(typeof helper === "function" ? helper.call(depth0 != null ? depth0 : {},options) : helper));
	  if (!helpers.musics) { stack1 = helpers.blockHelperMissing.call(depth0,stack1,options)}
...
/***/ function(module, exports) {
	...
	var Player = function () {
	  function Player() {
	    ...
	    this._$e.on('embedplayer:statechange', function (e) {
	
	      _this._events.statechange(e.state, _this._playOp);
	    }).on('embedplayer:error', function (e) {
	      _this._events.error(e.error);
	    }).on('embedplayer:durationchange', function (e) {
	      _this._events.durationchange(e.duration);
	    }).on('embedplayer:volumechange', function (e) {
	      if (e.volume) _this._volume = e.volume;
	
	      _this._events.volumechange(e.volume);
	    }).on('embedplayer:timeupdate', function (e) {
	      _this._events.timeupdate(e.currentTime);
	    }).embedplayer('listen'); // enable all events
	  }
	
	  _createClass(Player, [{
	    key: 'play',
	    value: function play(music_id) {
	      if (music_id) {
	        var music = this.getMusicInfo(music_id);
	
	        if (music.src) this._$e.attr('src', music.src);else this._socket.emit('set Music', music.index);
	      } else {
	        if (this._list === null) {
	          $('.music-tr').eq(0).click();
	    ...
	    value: function pause() {
	      this._$e.embedplayer('pause');
	    }
	  }, {
	    key: 'seek',
	    value: function seek(time) {
	      this._$e.embedplayer('seek', time);
	    }
	  }, {
	    key: 'vol',
	    value: function vol(volume) {
	      this._$e.embedplayer('volume', volume);
	    }
	  }, {
	    key: 'vol_on',
	    value: function vol_on() {
	      this._$e.embedplayer('volume', this._volume);
	    }
	  }, {
	    key: 'vol_off',
	    value: function vol_off() {
	      this._$e.embedplayer('volume', 0);
	    }
	  }, {
	    key: 'prev',
	    value: function prev() {
	    ...
	    key: '_shufflePlay',
	    value: function _shufflePlay() {
	      this._index = parseInt(Math.random() * this._list.length);
	      var music = this._list[this._index];
	      console.log(music);
	    ...
	    key: 'setPlayOption',
	    value: function setPlayOption(option, value) {
	      if (_typeof(this._playOp[option]) !== undefined) {
	        this._playOp[option] = value;
	      }
	    }
	  }, {
	    key: 'setMusic',
	    value: function setMusic(idx, buffer) {
	      var _this2 = this;
	      ...
	      this._list.forEach(function (music, listIndex) {
	        if (music.index === idx) {
	          _this2._list[listIndex].src = url;
	          _this2._$e.attr('src', url);
	        }
	      });
	    }
	  }, {
	    key: 'setIndex',
	    value: function setIndex(music_id) {
	      var _this3 = this;
	
	      this._list.forEach(function (music, listIndex) {
	        if (music.index === music_id) _this3._index = listIndex;
	      });
	    }
	  }, {
	    key: 'getMusicId',
	    value: function getMusicId() {
	    ...
	    key: 'getListKey',
	    value: function getListKey() {
	      return this._listKey;
	    }
	  }, {
	    key: 'getMusicInfo',
	    value: function getMusicInfo(music_id) {
	      if (music_id) {
	        var musicInfo = void 0;
	
	        this._list.forEach(function (music) {
...
/***/ function(module, exports) {
	...
	var PlayerUI = function () {
		...
		_createClass(PlayerUI, [{
			...
			value: function _repeatEvent() {
				...
				$repeat.click(function () {
					if ($repeat.hasClass('on')) {
						...
						_this3._status.repeat = false;
						_this3._status.repeat_one = true;
	
						cb(_this3._status);
					} else {
						$repeat.addClass('on');
	
						_this3._status.repeat = true;
						_this3._status.repeat_one = false;
			...
			value: function _shuffleEvent() {
				...
				$shuffle.click(function () {
					if ($shuffle.hasClass('on')) {
						_this4._status.shuffle = false;
						$shuffle.removeClass('on');
	
						cb(_this4._status);
					} else {
						_this4._status.shuffle = true;
						$shuffle.addClass('on');
			...
			key: '_prevEvent',
			value: function _prevEvent() {
				var cb = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : function () {};
	
				var $e = $(this.fast_rewind);
			...
			value: function togglePlay() {
				...
				if (option) {
					...
					if (option === 'play') $play.show();else if (option === 'pause') $pause.show();
				} else {
					$play.toggle();
					$pause.toggle();
				}
			...
			key: 'setRepeatOne',
			value: function setRepeatOne(op) {
				var cb = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : function () {};
...
/***/ function(module, exports) {
	...
	var VoiceCommand = function () {
	  function VoiceCommand(obj_func) {
	    _classCallCheck(this, VoiceCommand);
	    ...
	    this._obj_command = {
	      ...
	      'not repeat': function notRepeat() {
	        obj_func.repeat('off');
	      },
	      'volume *op': obj_func.set_volume,
	      'mute': function mute() {
	        obj_func.set_volume('mute');
	      },
	  ...
	  _createClass(VoiceCommand, [{
	    ...
	    key: 'getFunctions',
	    value: function getFunctions(command) {
	      if (!command) {
